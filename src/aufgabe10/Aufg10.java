...
public class Aufg10 implements Plottable
{
  ...
  public double inf() { return 0;}
  
  public double sup() { return 2*Math.PI;}
  
  public double x (double t) { return a*Math.sin(t); }
  
  public double y (double t) { return b*Math.cos(t); }
