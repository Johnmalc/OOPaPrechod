...
public class Main {
	 ...
	 *         Kennung mit 1 als erster Ziffer Gebühr 0,5% vom Wert
	 *         Aktienfonds: 2 als erste Ziffer Gebühr Sockelbetrag 30€,
	 *         zusätzlich 0,2% vom Wert Rentenfonds: 3 als erste Ziffer Gebühr
	 *         0,05% pro Stück Alle Gebühren sollen änderbar sein.
	 * 
	 * 
	 * 
	 */
	...
	public static void main(String[] args) {
		...
		while (!dop) {
			...
			case 100_000:
				...
				System.out
						.println("Wie viel aktien wollen danach sie verkaufen ?");
				...
				// "wert insgesamt"
				System.out.println("The value of the share is "
						+ share2.getValue());
			...
			case 200_000:
				...
				System.out.println("Den jauf wir sie "
						+ aktienf.berechneGebuhr() + " zusammen kosten");
				System.out
						.println("Welchen wert besitzen hedgefond auf der borse "
								+ aktienf.getValue());
