...
public class PraktikumsAufgabeVier2 {
	...
	public static void main(String[] args) {
		...
		while (ende == false) {
			...
			System.out
					.println("4 = Daten an bestimmter Indexposition speichern");
			...
			case 2: // Gespeicherte Daten Anzeigen
				...
				System.out
						.println("Welche Studenten Daten sollen Angezeigt werden? (1-10)");
			...
			case 3: // Gespeicherte Daten loeschen!
				...
				System.out
						.println("Welche Studenten Daten sollen gel�scht werden? (1-10)");
			...
			case 4: // Daten an bestimmter Indexposition speichern !
				...
				System.out
						.println("Auf Welche Index Position sollen Ihre Daten gespeichert werden (1-10)?");
				indexPosition = IOTools.readInteger("Ihre Wahl = ");

				if (speicher[indexPosition - 1] != null) {
					System.out.println("");
					System.out
							.println("WARNUNG!!! An dieser Indexposition befinden sich bereits gespeicherte Daten die beim Fortfahren von ihnen �berschrieben werden. Trotzdem Fortfahren?");
					System.out.println("");
					...
					if (antwortIndex.equals("Ja")) {
						...
						System.out.println("");
						System.out
								.println("Ihre Daten sind an der gew�nschten Position gespeichert worden");
