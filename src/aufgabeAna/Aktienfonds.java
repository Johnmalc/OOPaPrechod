...
public class Aktienfonds extends Depotverwaltung {
	private String Kennung;
	private double Gebuehr;
	private int Stueckzahl;
	private double Kurs;

	public Aktienfonds(String kennung) {
		if (kennung.length() == 6 && kennung.charAt(0) == '3') {
			Kennung = kennung;
			Gebuehr = 0.0005;
			Stueckzahl = 1;
			Kurs = 100;
			...
			System.out
					.println("Fehler! Bitte sechsstellige Kennung mit 3 als erster Ziffer.");
		} // end of if-else
	}
